...
namespace SmartShop.WebAdmin.Controllers
{
    public class ProductCategoriesController : Controller
    {
        ...
        public ProductCategoriesController(SmartShopContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.ProductCategories != null ? 
                          ...
                          Problem("Entity set 'SmartShopContext.ProductCategories'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,ShopId,Name,Description")] ProductCategory productCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,ShopId,Name,Description")] ProductCategory productCategory)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(Guid id)
        {
            ...
            {
                return Problem("Entity set 'SmartShopContext.ProductCategories'  is null.");
            }
            var productCategory = await _context.ProductCategories.FindAsync(id);
            if (productCategory != null)
            {
